    ...
    <div
        ...
        <div
            ...
            <div class="!tw-w-full md:!tw-w-none !tw-flex md:!tw-hidden !tw-flex-row !tw-items-center !tw-gap-3">
                ...
                {{-- M-Pesa express button (mobile) --}}
                @if (array_key_exists('custom_pay_1', $payment_types))
                    <button type="button"
                        id="pos-mpesa-mobile"
                        class="tw-font-bold tw-text-white tw-cursor-pointer tw-text-xs md:tw-text-sm tw-bg-[#00A550] tw-p-2 tw-rounded-md tw-w-[5.5rem] tw-flex tw-flex-row tw-items-center tw-justify-center tw-gap-1 no-print"
                        title="Pay with M-Pesa">
                        <i class="fas fa-mobile-alt" aria-hidden="true"></i> M-Pesa
                    </button>
                @endif
            ...
            <div class="tw-flex tw-items-center tw-gap-4 tw-flex-row tw-overflow-x-auto">
                ...
                {{-- M-Pesa express button (desktop) --}}
                @if (array_key_exists('custom_pay_1', $payment_types))
                    <button type="button"
                        id="pos-mpesa-desktop"
                        ...
                        title="Pay with M-Pesa">
                        <i class="fas fa-mobile-alt tw-text-[#00A550]" aria-hidden="true"></i> M-Pesa
                    </button>
                @endif
                ...
                @if (array_key_exists('custom_pay_1', $payment_types))
                    <button type="button"
                        id="pos-mpesa-desktop"
                        class="tw-font-bold tw-text-white tw-cursor-pointer tw-text-xs md:tw-text-sm tw-bg-[#00A550] tw-p-2 tw-rounded-md tw-w-[8.5rem] tw-hidden md:tw-flex lg:tw-flex lg:tw-flex-row lg:tw-items-center lg:tw-justify-center lg:tw-gap-1 no-print"
                        title="Pay with M-Pesa">
                        <i class="fas fa-mobile-alt" aria-hidden="true"></i> M-Pesa
                    </button>
                @endif
...
@include('sale_pos.partials.mpesa_payment_modal')

...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/reports/mpesa-transactions', [ReportController::class, 'getMpesaTransactions']);
    ...
    Route::prefix('mpesa')->name('mpesa.')->group(function () {
        ...
        // Frontend polls every 3 seconds to check payment status
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu'])->group(function () {
    Route::get('/mpesa/transactions', [\App\Http\Controllers\MpesaPaymentController::class, 'transactions'])->name('mpesa.transactions');
});